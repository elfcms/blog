...
<details class="blog-nav-category">
    <summary>
        ...
        <div class="blog-nav-buttons">
            ...
            <a href="{{ route('admin.blog.categories.create',['category_id'=>$cat->id]) }}" class="blog-nav-button add-category" title="{{ __('blog::default.add_category') }}"></a>
            ...
            <div class="contextmenu-content-box">
                ...
                <a href="{{ route('admin.blog.categories.create',['category_id'=>$cat->id]) }}" class="contextmenu-post" title="{{ __('blog::default.add_category') }}"></a>
